      ...
      <div class="row page">
        ...
        <div class="col-lg-6 col-md-6">
          ...
          <div class="my-4 formdata">
            <form class="my-4" id="loginForm" method="POST" action="loginConfirm.php">
              ...
              <div class="my-3">
                <p>NOTICE: MAKE SURE YOUR USERNAME MATCHES PASSWORD</p>
                <p>OTHERWISE, WARNINGS WILL BE SHOWN</p>
                <div class="warning">
                  <?php if(isset($_SESSION['logErr'])||!empty($_SESSION['logErr'])): ?>
                    <?php echo $_SESSION['logErr'];?>
                  <?php endif;?>
                </div>
              </div>
              <button class="btn submitBut py-4" type="submit">
                Start Wandering
              </button>
            </form>
          </div>
